...
define("GSLAN_34", "Primeiro, crie os links que você quer que sejam listados no seu mapa do site/sitemap. Você pode importar a maioria dos seus links clicando no botão 'Importar' na direita");
...
define("GSLAN_37", "Assim que você tiver algumas entradas, vá para [URL] e digite a seguinte URL: [URL2] - se esta url não estiver correta para você, favor certificar-se que seu site está com o endereço correto na área de administração -> [preferences]");
define("GSLAN_38", "Para mais informações sobre o protocolo de Mapas de Site do Google, vá para [URL].");
