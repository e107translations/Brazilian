...
+---------------------------------------------------------------+
|        e107 website system
|        ../../e107_plugins/gsitemap/languages/gsitemap_Portuguese_Brazilian.php
...
define("GSLAN_34", "Primeiro, crie os links que você quer que sejam listados no seu mapa do 
site/sitemap. Você pode importar a maioria dos seus links clicando no botão 'Importar' na direita");
...
define("GSLAN_37", "Assim que você tiver algumas entradas, vá para <a
href='https://www.google.com/webmasters/sitemaps/stats'>https://www.google.com/webmasters/sitemaps/stats</a> 
e digite a seguinte URL -> <b>.SITEURL.gsitemap.php</b> - se esta url não 
estiver correta para você, favor certificar-se que seu site está com o 
endereço correto na área de administração -> preferências");
define("GSLAN_38", "Para mais informações sobre o protocolo de Mapas de Site do Google, vá para 
<a href='http://www.google.com/webmasters/sitemaps/docs/en/protocol.html'>http://www.google.com/webmasters/sitemaps/docs/en/protocol.html</a>.");
