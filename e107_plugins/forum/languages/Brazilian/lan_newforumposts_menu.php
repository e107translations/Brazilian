...
+---------------------------------------------------------------+
*/
define("NFP_1", "Todas as últimas postagens estão fora do alcance de sua classe de usuários, não há como exibir.");
...
define("NFP_9", "Atualizar configurações do menu");
