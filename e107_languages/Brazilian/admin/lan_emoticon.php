...
define("EMOLAN_31", "Total de [x] arquivos encontrados");
define("EMOLAN_32", "Pacote desconhecido deletado");
define("EMOLAN_33", "Formato de Arquivo XML não suportado");
define("EMOLAN_34", "Arquivos faltando no pacote");
define("EMOLAN_35", "- deletado no banco de dados");
define("EMOLAN_37", "Emote não setado");
