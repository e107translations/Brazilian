...
define("NWSLAN_29a", "Notícias - Atualizar Item Existente");
...
define("NWSLAN_46a", "Categorias de Notícias");
...
define("NWSLAN_116", "Atualize primeiramente as preferências com a exibição mudada para a exibição da página, depois atualize então outra vez a preferência arquivo-notícia. (0 (zero) significa desativado)");
...
define("LAN_NEWS_60", "Total de Comentários");
...
define("LAN_NEWS_65", "Por favor, escolha a sequência de caracteres de URL SEF exclusiva para esta categoria");
define("LAN_NEWS_67", "Fechar");
define("LAN_NEWS_68", "Item enviado");
define("LAN_NEWS_69", "Área padrão");
define("LAN_NEWS_70", "Área padrão - título");
define("LAN_NEWS_71", "Área padrão - título/Resumo");
...
define("LAN_NEWS_95", "Outra notícia item é usando o SEF URL: [x]");
define("LAN_NEWS_96", "Aprovar");
define("LAN_NEWS_97", "Menu de grade de notícias");
define("LAN_NEWS_98", "Serviços de ping");
define("LAN_NEWS_99", "Só aceita imagens maiores que");
define("LAN_NEWS_100", "Qualquer tamanho");
define("LAN_NEWS_101", "Enviar notícias");
define("LAN_NEWS_102", "Abrir em nova aba");
define("LAN_NEWS_103", "Notificação por e-mail");
define("LAN_NEWS_104", "Desencadear uma notificação por e-mail quando você enviar este formulário.");
define("LAN_NEWS_105", "Notificação de e-mail disparada!");
define("LAN_NEWS_106", "Visibilidade de item de notícias deve incluir 'todos' para notificações por email trabalhar.");
define("LAN_NEWS_107", "Verificação de Status do Ping");
define("LAN_NEWS_108", "O SEF URL é diferente do título de seu artigo de notícias.");
