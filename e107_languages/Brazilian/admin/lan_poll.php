...
define("POLLAN_7", "Questão para Pesquisa");
define("POLLAN_8", "Opção");
define("POLLAN_9", "Adicionar outra opção");
define("POLLAN_10", "Estado da pesquisa");
define("POLLAN_11", "Inativa");
define("POLLAN_12", "Ativa - Permitir votos de todos");
define("POLLAN_13", "Ativa - permitir votos só de membros");
