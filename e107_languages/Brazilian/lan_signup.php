...
define("LAN_SIGNUP_13", "Você pode agora logar-se utilizando o menu de login, ou clicando [aqui].");
...
define("LAN_SIGNUP_30", "Se você não quiser mostrar o endereço de e-mail no site, por favor clique na caixa 'Sim' para 'esconder o endereço de e-mail'.");
...
define("LAN_SIGNUP_61", "Enviado com sucesso");
define("LAN_SIGNUP_62", "Envio falhou");
define("LAN_SIGNUP_63", "Email enviado com solicitação de reset de senha");
define("LAN_SIGNUP_64", "Isto não parece ser uma informação válida de usuário");
define("LAN_SIGNUP_65", "O seguinte nome de login foi designado a você");
define("LAN_SIGNUP_66", "Favor anotá-lo");
define("LAN_SIGNUP_67", "Isto será designado pelo sistema depois de você se inscrever");
define("LAN_SIGNUP_71", "Você alcançou o número limite de registros no site. Favor fazer login usando uma de suas outras contas.");
...
define("LAN_SIGNUP_74", "Sua conta está ativa agora");
define("LAN_SIGNUP_75", "Registro ativado");
define("LAN_SIGNUP_76", "Obrigado! Você agora é um membro registrado de");
define("LAN_SIGNUP_77", "Este site está em conformidade com o COPPA (The Children's Online Privacy Protection Act) de 1998 e não aceita registro de usuários com idade inferior a 13 anos sem um documento por escrito de autorização de responsáveis. Para mais informações, você pode ler a legislação");
define("LAN_SIGNUP_78", "Registro");
define("LAN_SIGNUP_79", "Registrar");
define("LAN_SIGNUP_80", "Favor digitar seus dados abaixo.");
define("LAN_SIGNUP_81", "Usuário:");
define("LAN_SIGNUP_82", "o nome que você usará para fazer login");
define("LAN_SIGNUP_83", "Senha:");
define("LAN_SIGNUP_84", "Digite a senha novamente:");
define("LAN_SIGNUP_85", "Usuários e senhas podem conter maiúsculas e minúsculas.");
define("LAN_SIGNUP_89", "Mostrar Nome:");
define("LAN_SIGNUP_90", "o nome que será mostrado no site");
define("LAN_SIGNUP_91", "Nome Real:");
define("LAN_SIGNUP_93", "Assinatura:");
define("LAN_SIGNUP_94", "Seu Avatar:");
define("LAN_SIGNUP_95", "Digite o código visível na imagem");
define("LAN_SIGNUP_96", "Detalhes de registro para");
define("LAN_SIGNUP_97", "Bem-Vindo a");
...
define("LAN_SIGNUP_101", "Atualização dos dados falhou - favor entrar em contato com o administrador do site");
...
define("LAN_LOGINNAME", "Usuário");
define("LAN_USERNAME", "Nome de Exibição");
define("LAN_SIGNUP_107", "A senha deve ter um mínimo de [x] caracteres e incluir no mínimo uma letra MAIÚSCULA e um dígito");
define("LAN_SIGNUP_108", "Precisa ser um email válido");
define("LAN_SIGNUP_109", "é sensível a maiúsculas e minúsculas e não pode conter espaços");
define("LAN_SIGNUP_110", "Seu nome completo");
define("LAN_SIGNUP_111", "Digite a URL para a sua imagem ou escolha um avatar existente.");
define("LAN_SIGNUP_112", "Você está logado como Administrador Principal.");
define("LAN_SIGNUP_113", "Assinatura(s)");
define("LAN_SIGNUP_114", "Registo de utilizador está desactivado.");
define("LAN_SIGNUP_115", "E-mail de activação de visualização");
define("LAN_SIGNUP_116", "Visualização após o envio do formulário");
define("LAN_SIGNUP_117", "Enviar um teste de ativação");
define("LAN_SIGNUP_118", "Para [X]");
define("LAN_SIGNUP_119", "Não enviar e-mail");
define("LAN_SIGNUP_120", "OU");
define("LAN_SIGNUP_121", "Use um endereço de e-mail diferente");
define("LAN_SIGNUP_122", "Política de Privacidade");
define("LAN_SIGNUP_123", "Termos e Condições");
define("LAN_SIGNUP_124", "Ao se inscrever, você concorda com nossos [x] e nossos [y].");
define("LAN_SIGNUP_125", "Mínimo de [x] caracteres");
