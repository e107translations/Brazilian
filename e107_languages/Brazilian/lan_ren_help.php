...
define("LANHELP_17", "Tamanho Normal");
define("LANHELP_18", "Grande");
define("LANHELP_19", "Maior");
define("LANHELP_20", "Gigante");
define("LANHELP_21", "Clique para abrir diálogo de Cor...");
define("LANHELP_22", "Clique para abrir diálogo de Tamanho...");
define("LANHELP_23", "Insere link: \n[link]http://meusite.com.br[/link] ou  [link=http://seusite.com.br]Visite meu Site[/link]");
define("LANHELP_24", "Texto negrito:\n[b]Este texto ficará em negrito[/b]", "font-weight:bold; width: 20px");
define("LANHELP_25", "Texto itálico:\n[i]Este texto ficará em itálico[/i]", "font-style:italic; width: 20px");
define("LANHELP_26", "Texto sublinhado:\n[u]Este texto ficará sublinhado[/u]", "text-decoration: underline; width: 20px");
define("LANHELP_27", "Insere imagem:\n[img]minhafigura.jpg[/img]");
define("LANHELP_28", "Alinhamento centralizado:\n[center]Esse texto ficará centralizado[/center]");
define("LANHELP_29", "Alinhamento esquerdo:\n[left]Esse texto ficará alinhado pela esquerda[/left]");
define("LANHELP_30", "Alinhamento à direita:\n[right]Esse texto ficará alinhado pela direita[/right]");
...
define("LANHELP_45", "Inserir imagem do Gerenciador de Mídias:");
...
define("LANHELP_50", "Tamanho do texto: para H2 [h]Texto de Título[/h] ou [h=2]Texto de Título[/h]");
define("LANHELP_51", "Desativar o HTML para novas linhas de texto: [nobr]texto[/nobr]");
